        ...
        <div className="app-body">
          ...
          <main className="app-content">
            <Routes>
              ...
              <Route path="/radiology" element={<Radiology />} /> {/* Add this line */}
              <Route path="/Doctorhomepage" element={< Doctorhomepage />} /> {/* Add this line */}
              <Route path="/InputMedical" element={< InputMedical />} /> {/* Add this line */}
              {/* ... other routes */}
            </Routes>
          </main>
        </div>
