...
class AccountSettings extends Component {
  ...
  renderPersonalInfoForm = () => {
    const { firstName, lastName, email, phoneNumber, address, allergies, emergencyContact, bloodType, specialCondition, height, weight } = this.state;
    ...
    return (
      <div className="account-settings">
        <Modal show={this.state.showModal} onHide={this.handleCloseModal}>
          ...
          <Modal.Body>Your account settings have been successfully updated.</Modal.Body>
          <Modal.Footer>
